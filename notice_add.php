...
<div class="row" style="height:100%;">
    ...
    <div class="col-md-4">
        <div class="left_navber">
            <ul>
                ...
                <li><a class="active" href="notice_add.php">Add Notice</a></li> 
            </ul>
        </div>
    </div>
    ...
    <div class="col-md-8">
        <div class="card_body mt_40">
            ...
            <div class="form_div">
                <form action="app/noticeAdd.php" method="post"> 
                    <div class="form-group">
                        <label for="name">Notice Title</label>
                        <input class="form-control" type="text" placeholder="Enter Full Name" name="title" required>
                    </div>

                    <div class="form-group">
                        <label for="description">Description</label>
                        <textarea id="description" name="description" rows="6" style="width: 93%"> </textarea>
